...
*  Email : jacky@eelf.cn                                        *
*  Site : www.eelf.cn                                           *
*  Create Time : 2025-12-10 21:46:10                            *
*  Version : v 1.0.0                                            *
...
namespace XiaoFeng.OPC.XML
{
    ...
    /// 帮助文件
    /// </summary>
    public static class OpcXmlHelper
    {
        #region 属性
        /// <summary>
        /// 标准 OPC XML-DA 1.0 命名空间
        /// </summary>
        public const string Namespace = "http://opcfoundation.org/webservices/XMLDA/1.0/";
        /// <summary>
        /// SOAP 1.1 信封命名空间
        /// </summary>
        public const string Soap11EnvelopeNamespace = "http://schemas.xmlsoap.org/soap/envelope/";
        /// <summary>
        /// SOAPAction 模板(替换{0}为操作名)
        /// </summary>
        public const string SoapActionTemplate = "http://opcfoundation.org/webservices/XMLDA/1.0/{0}";
        #endregion
